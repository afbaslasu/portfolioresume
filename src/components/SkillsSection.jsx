...
const skillsData = {
  ...
  description:
    "My technical proficiency spans across the full development stack, with specialized focus on creating responsive, accessible, and performant web applications.",
  categories: [
    {
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "UI Principles", level: 95 },
        { name: "Interaction Design", level: 92 },
        { name: "Accessibility", level: 94 },
      ],
    },
    {
      name: "Backend & DevOps",
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Performance Opt", level: 91 },
        { name: "Cross-browser", level: 93 },
      ],
    },
    {
      name: "Tools & Methods",
